...
object IIDProbability {
  ...
  implicit def at[R : AdditiveMonoid, P <: Probability[R], C <: Traversable[P], I, T](implicit p_t: Lens[P, T], cAt: At[C, I, P], pAt: NoImplicit[At[P, I, T]]): At[IIDProbability[R, P, C], I, T] = new At[IIDProbability[R, P, C], I, T] {
    override def at(i: I): Lens[IIDProbability[R, P, C], T] = ps[R, P, C] ^|-> cAt.at(i) ^|-> p_t
  }

  implicit def atAll[R : AdditiveMonoid, P <: Probability[R], C <: Traversable[P], I, T](implicit pAt: At[P, I, T], cbf: CanBuildFrom[Traversable[P], P, C]): At[IIDProbability[R, P, C], I, T] = new At[IIDProbability[R, P, C], I, T] {
